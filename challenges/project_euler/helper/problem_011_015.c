...
#define PRB_11_ROWS 20
#define PRB_11_COLS 20
#define PRB_11_DIGIT_NUM 4
#define PRB_11_SEARCH_LOOP PRB_11_ROWS - PRB_11_DIGIT_NUM
    ...
    while (divisors < 500) {
        ...
        for (int divisor = 1; divisor <= t_num_root; divisor++) {
            if (triangular_number % divisor == 0) {
                ...
                // you get the higher divisor as a quotient, and it probably does not
                // fall below the square root of the main number
            }
        }
