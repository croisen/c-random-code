...
void problem_011(void)
{
    ...
    col_limited_printf(80, 0, "Problem 011 - Largest Product in a Grid\n");
    col_limited_printf(
        80, 0,
    ...
    col_limited_printf(
        80, 0,
        "The product of these numbers is 26 * 63 * 78 * 14 = 1788698.\n"
        "Goal: What is the greatest product of four adjacent numbers in the "
